...
GR_REGISTER_BLOCK(gr::basic::Convert, ([T], [U]), [ uint8_t, uint16_t, uint32_t, uint64_t, int8_t, int16_t, int32_t, int64_t, float, double ], [ uint8_t, uint16_t, uint32_t, uint64_t, int8_t, int16_t, int32_t, int64_t, float, double ])
...
GR_REGISTER_BLOCK(gr::basic::ScalingConvert, ([T], [U]), [ uint8_t, uint16_t, uint32_t, uint64_t, int8_t, int16_t, int32_t, int64_t, float, double ], [ uint8_t, uint16_t, uint32_t, uint64_t, int8_t, int16_t, int32_t, int64_t, float, double ])
...
GR_REGISTER_BLOCK(gr::basic::Abs, [T], [ uint8_t, uint16_t, uint32_t, uint64_t, int8_t, int16_t, int32_t, int64_t, float, double, std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::Imag, [T], [ std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::Real, [T], [ std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::Arg, [T], [ std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::RadiansToDegree, [T], [ float, double ])
...
GR_REGISTER_BLOCK(gr::basic::DegreeToRadians, [T], [ float, double ])
...
GR_REGISTER_BLOCK(gr::basic::ToRealImag, [T], [ std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::RealImagToComplex, [T], [ float, double ])
...
GR_REGISTER_BLOCK(gr::basic::ToMagPhase, [T], [ std::complex<float>, std::complex<double> ])
...
GR_REGISTER_BLOCK(gr::basic::MagPhaseToComplex, [T], [ float, double ])
...
GR_REGISTER_BLOCK(gr::basic::ComplexToInterleaved, ([T], [U]), [ std::complex<float>, std::complex<double> ], [ float, double ])
...
GR_REGISTER_BLOCK(gr::basic::InterleavedToComplex, ([T], [U]), [ float, double ], [ std::complex<float>, std::complex<double> ])
